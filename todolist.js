let todoText;
let todoList = JSON.parse(localStorage.getItem('todos')) || [{ id: 12367, todo: 'Buy Java Script Book', isCompleted: false }, { id: 38921, todo: 'Go to gym', isCompleted: false }, { id: 45383, todo: 'Prepare  For Interview', isCompleted: false }, { id: 12464, todo: 'Practice Js Problems', isCompleted: false }, { id: 15623, todo: 'Buy  Milk', isCompleted: false }];


//this fn is used to add task
function addTask() {
    todoText = document.getElementById('todo-input');
    const randomFiveDigit = Math.floor(Math.random() * (99999 - 10000 + 1)) + 10000;

    todoList.push({ id: randomFiveDigit, todo: todoText.value, isCompleted: false })
...
function displayTodoListData() {
    ...
    for (let i = 0; i < todoList.length; i++) {
        ...
        nameCell.classList.add('todo-list-name', todoList[i].isCompleted ? 'strike' : 'none')
